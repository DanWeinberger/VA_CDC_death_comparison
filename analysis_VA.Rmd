...
plot.fun(ds= v1[v1$sex=='M' &v1$race_recode=='1',], xvar='date', yvar='N_deaths')

plot.fun(ds= v1[v1$sex=='F' &v1$race_recode=='1',], xvar='date', yvar='N_deaths')

plot.fun(ds= v1[v1$sex=='M' &v1$race_recode=='2',], xvar='date', yvar='N_deaths')
```
...
p1 + facet_wrap(~race_recode, scales='free')
...
p1 + facet_wrap(~region, scales='free')
