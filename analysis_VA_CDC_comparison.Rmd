...
# ggsave('Fig S1 rr_region_age.jpg',path = './plots', width = 8, height =6, device='jpg', dpi=400)
 ...
 ggsave('Fig S2 rr_region_age.jpg',plot=p.rr_region,path = './plots', width = 8, height =6, device='jpg', dpi=400)
...
ggsave('Figure 1 rr_plot.pdf',path = './plots', width = 6, height = 3, device='pdf', dpi=400)
...
p2
ggsave('Figure 2 obs_exp_age.pdf',plot=p2,path = './plots', width = 8, height = 4.2, device='pdf', dpi=300)
